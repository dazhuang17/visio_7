...
cscript //nologo ospp.vbs /act | find /i "successful" && (echo finished，press any key exit) || (echo connected KMS server failde! try another… & echo please waiting... & echo. & echo. & set /a i+=1 & goto server)
pause >nul
exit